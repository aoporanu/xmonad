...
myStartupHook = do
  ...
  -- spawn arandr script
  spawnOnce "arandr ~/.screenlayout/arandr.sh"
  -- spawnOnce "xargs xwallpaper --stretch < ~/.cache/wall"
  -- spawnOnce "~/.fehbg &"  -- set last saved feh wallpaper
  spawnOnce "feh --bg-fill --bg-scale --no-fehbg ~/wallpapers/wallpaperflare.com_wallpaper.jpg"  -- feh set random wallpaper
...
myKeys c =
  ...
  , ("<XF86MonBrightnessDown>", addName "Decrease brightness" $ spawn "brightnessctl s 10%-")
  ...
  -- spawnOnce "feh --bg-fill --bg-scale --no-fehbg ~/wallpapers/wallpaperflare.com_wallpaper.jpg --bg-fill --bg-scale --no-fehbg ~/wallpapers/wallpaperflare.com_wallpaper.jpg" -- feh set random wallpaper
main :: IO ()
main = do
